...
Toast.prototype.showWithOptions = function (
  options,
  successCallback,
  errorCallback
) {
  options.duration =
    options.duration === undefined ? "long" : options.duration.toString();
...
Toast.prototype.showShortTop = function (
  message,
  successCallback,
  errorCallback
) {
...
Toast.prototype.showShortCenter = function (
  message,
  successCallback,
  errorCallback
) {
...
Toast.prototype.showShortBottom = function (
  message,
  successCallback,
  errorCallback
) {
...
Toast.prototype.showLongTop = function (
  message,
  successCallback,
  errorCallback
) {
...
Toast.prototype.showLongCenter = function (
  message,
  successCallback,
  errorCallback
) {
...
Toast.prototype.showLongBottom = function (
  message,
  successCallback,
  errorCallback
) {
